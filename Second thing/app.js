...
for (const imgID of imgList) {
  ...
  content += `<img src="https://picsum.photos/id/${imgID}/200/300" alt = "Random Animal Image">`;
  console.log(imgID);
}

console.log(content);

//NOTE: React will replace all the code below; innerHTML is a bad idea due to injections

// Using `document.querySelector()`, assign the .gallery element to a variable.
//QUERY SELECTOR CAN INTERFACE BETWEEN HTML AND JS
//classList IS USED TO INTERFACE BETWEEN CSS AND JS
